...
function Testimonials() {
    const testimonials = [{
        ...
        image: testimonial_1,
        rating: 5,
        review: "I've tried differnt hotel apps, but none matched the personal touch and attention to detail that this service offers. Their handpicked hotel list is truly exceptional."
    },
    {
        id: 1,
        name: "Liam Johnson",
    ...
    return (
        <section className='py-16 bg-gray-50'>
            <div className='max-w-6xl mx-auto px-4 text-center'>
                ...
                <p className='text-gray-600 mb-10 max-w-2xl mx-auto'>Real experiences from real travelers. Discover why people love booking with us  </p>
                <div className='grid md:grid-cols-3 gap-6'>
                    {testimonials.map((testimonial, index) =>

                        <div key={index} className='bg-white rounded-xl shadow-md p-4 text-left hover:shadow-lg transition'>
                            <div className='flex items-center gap-4 mb-4'>
                                <img className='w-14 h-14 rounded-b-full object-cover' src={testimonial.image} />
                                <div>
                            ...
                            <p className='text-gray-600 tex-sm'> {testimonial.review}</p>
