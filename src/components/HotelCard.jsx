...
function HotelCard() {
    const hotels = [
        { name: "Grand Place Hotel", rating: 4.5, location: "New York, USA", price: "120$", image: hotel_1 },
        { name: "Sunrise Resort", rating: 4.8, location: "Santorini, Greece", price: "180$", image: hotel_2 },
        { name: "City Inn", rating: 4.2, location: "Tokyo, Japan", price: "95$", image: hotel_3 },
        { name: "Oceanview", rating: 4.7, location: "Barcelona, Spain", price: "150$", image: hotel_4 }
    ];
            ...
            <div className='grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6'>
                {hotels.map((hotel, index) => (
                    <div className='bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300' key={index}>
                        <img className='h-48 w-full object-cover' src={hotel.image} alt={hotel.name} />
                        <div className='p-4'>
