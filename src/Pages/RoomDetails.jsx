    ...
    return (
        <div className='max-w-5xl mx-auto px-40  pt-60'>
            <div className='text-center'>
                ...
                <p className=' text-gray-600 mb-2 flex items-center justify-center gap-2'><FaLocationArrow />{hotel.address}</p>
            ...
            <div className=' grid sm:grid-cols-1 md:grid-cols-2 '>
                ...
                <div className='mt-10'>
                    ...
                    <iframe src={`https:www.google.com/maps?q=${encodeURIComponent(hotel.address)}&output=embed`} width="200%" height="450px" className='rounded-md shadow' loading='lazy' title='map'>
